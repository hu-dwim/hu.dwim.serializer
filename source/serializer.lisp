...
(def (function io) write-object-slots/primitive (object context &optional (slots (closer-mop:class-slots (class-of object))))
  ...
  (bind ((class (class-of object))
         (slots (remove-if (lambda (slot) (eq (ignore-errors (closer-mop:slot-definition-allocation slot)) :class)) slots))) ;; TODO THL rewrite nicely (not defined/portable for structures)
